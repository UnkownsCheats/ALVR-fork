...
devices! {
    ...
    (BASE_STATION_1, "/user/tracking/base_station/1"),
    (BASE_STATION_2, "/user/tracking/base_station/2"),
    (BASE_STATION_3, "/user/tracking/base_station/3"),
    (BASE_STATION_4, "/user/tracking/base_station/4"),
}
